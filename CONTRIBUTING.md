...
The following is a set of guidelines for contributing to the NGINX Wrapper. We really appreciate that you are considering contributing!
...
* Fill in [our pull request template](https://github.com/nginxinc/nginx-wrapper/blob/master/.github/PULL_REQUEST_TEMPLATE.md)
